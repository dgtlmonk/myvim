...
hi SpecialComment   ctermfg=87                                     cterm=none
...
hi Todo             ctermfg=228             ctermbg=NONE            cterm=none
...
hi Search           ctermbg=214            cterm=bold,underline
...
" HTML 
" ------------
hi htmlTag            guifg=#b6bf98           guibg=#363946           gui=none
hi htmlSpecialTagName guifg=#b6bf98           guibg=#363946           gui=none
hi htmlSpecialTagName ctermfg=150       	      ctermbg=none           gui=none

hi htmlTagName        guifg=#333333           guibg=#363946           gui=none
hi htmlTagName        ctermfg=154     	 ctermbg=none           gui=none
hi javaScript         ctermfg=167     	 ctermbg=none           gui=none

hi htmlEndTag         guifg=#b6bf98           guibg=#363946           gui=none
hi htmlEndTag         ctermfg=102             ctermbg=none           cterm=none
hi htmlCommentPart    ctermfg=102             ctermbg=none           cterm=none
hi htmlArg    	      ctermfg=229             ctermbg=none           cterm=none


" JavaScript
" ----------------------
hi jsObjectKey        ctermfg=229     	      ctermbg=none           
hi jsStorageClass     ctermfg=154     	      ctermbg=none           
hi Noise     		  ctermfg=167   	      ctermbg=none           
hi jsBrackets         ctermfg=red   	      ctermbg=none           
hi jsBraces           ctermfg=red   	      ctermbg=none           
" hi jsParen            ctermfg=167   	      ctermbg=none           S
hi jsFuncCall         ctermfg=154     	      ctermbg=none           
hi jsFuncName         ctermfg=154    	      ctermbg=none           
hi jsFunctionKey      ctermfg=154             ctermbg=none
hi Type		          ctermfg=white           ctermbg=none
hi jsFuncArgs         ctermfg=white    	      ctermbg=none
hi jsBlock	          ctermfg=214     	      ctermbg=none
hi jsLineComment      ctermfg=214     	      ctermbg=none          
